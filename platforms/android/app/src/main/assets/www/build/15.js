...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__log_surat__ = __webpack_require__(373);
...
var LogSuratPage = /** @class */ (function () {
    ...
    LogSuratPage.prototype.getLog = function (type, functionName) {
        ...
        this.isLoading = true;
        this.soapService
            .post(__WEBPACK_IMPORTED_MODULE_3__config__["a" /* api_base_url */], 'eoffice_log_surat', { fStream: JSON.stringify({ usernameEDI: __WEBPACK_IMPORTED_MODULE_3__config__["d" /* api_user */],
