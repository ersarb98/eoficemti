...
/**
 * Generated class for the ArsipPersonalPage page.
 *
...
@IonicPage()
@Component({
  selector: "page-arsip-personal",
  providers: [SoapService],
  templateUrl: "arsip-personal.html",
})
export class ArsipPersonalPage {
  messages: Array<any> = [];
  ...
  ionViewDidLoad() {
    console.log("ionViewDidLoad ArsipPersonalPage");
  }
  ...
  getMessages(type, functionName) {
    ...
    this.soapService
      .post(api_base_url, "eoffice_arsip", {
