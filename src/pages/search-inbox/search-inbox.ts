...
@Component({
  ...
  templateUrl: 'search-inbox.html',
})
export class SearchInboxPage {
  perihal:any = "";
  namaPengirim:any="";
  noSurat:any="";
  startDate:any = "";
  ...
  getmessages(type, functionName) {    
    ...
    this.soapService    
    .post(api_base_url,'eoffice_search_inbox',{fStream:JSON.stringify(
      {
  ...
  doArsip(data) {
    ...
    loading.present();
    this.soapService
    .post(api_base_url,'eoffice_arsip_add',{fStream:JSON.stringify(
      {
        usernameEDI : api_user, 
        passwordEDI : api_pass, 
