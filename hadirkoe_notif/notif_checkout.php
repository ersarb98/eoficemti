...
WHERE A.JAM_KELUAR IS NULL AND B.HADIRKOE = '1' AND TRUNC(A.TGL_CREATE) = TRUNC(SYSDATE)";
...
if (oci_execute($stid)) {	
	...
	$pushNotifikasi = array('usernameEDI' => 'EDI-USERNAME', 'passwordEDI' => 'RURJLVBBU1NXT1JE', 'nipp' => $arr_nipp, 'data' => array('res' => 'HomePage'), 'content' => array( 'en' => "Anda belum melakukan Check out kehadiran. Silakan Check out pada aplikasi E-Office IPCTPK Mobile/Mesin Absensi."), 'heading' => array( 'en' => "Check Out Kehadiran"));
